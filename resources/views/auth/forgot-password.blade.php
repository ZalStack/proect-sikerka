            ...
            <div class="w-full max-w-md xl:max-w-lg relative z-10 animate-slide-up">
                <div class="glass-card rounded-3xl shadow-2xl shadow-slate-900/10 p-6 sm:p-8 md:p-10 border border-white/40">
                    ...
                    <form method="POST" action="{{ route('password.verify') }}" class="space-y-5">
                        ...
                        <div class="animate-slide-up delay-200">
                            ...
                            <div class="flex items-center gap-3 bg-white/60 backdrop-blur-sm border border-gray-200 rounded-2xl p-3">
                                <div class="flex-1 text-center">
                                    <span class="text-2xl font-display font-bold text-slate-800 tracking-wider" id="captcha-text">{{ $captcha['text'] }}</span>
                                </div>
                                <button type="button" onclick="refreshCaptcha()" class="p-2 rounded-xl text-gray-400 hover:text-cyan-600 hover:bg-cyan-50 transition-all duration-200">
                        ...
                        <!-- Submit -->
                        <div class="pt-2 animate-slide-up delay-300">
                            <button type="submit"
