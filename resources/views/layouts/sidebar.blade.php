    ...
    <div class="p-4">
        ...
        <nav class="space-y-2">
            @if($isHr)
                ...
                <!-- Kepala Suku -->
                <a href="#"
                   onclick="event.preventDefault(); alert('Menu Pamer Suku saat ini masih dalam tahap pengembangan dan akan segera tersedia. Terima kasih atas kesabaran Anda.');"
