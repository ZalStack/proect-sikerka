            ...
            <div class="bg-[#27438D] rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
                <div class="flex items-center space-x-2 sm:space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-white font-semibold text-xs sm:text-sm truncate" title="{{ $user->nama_lengkap }}">
                            {{ $shortName }}
                        </p>
            ...
            <nav class="space-y-0.5 sm:space-y-1">
                @if ($isHr)
                    ...
                    <div class="pt-2 mt-2 border-t border-[#27438D]">
                        <h4 class="text-[#00a2e9] text-[10px] sm:text-xs font-bold uppercase tracking-wider px-3 sm:px-4 py-2">Lainnya</h4>
                    </div>
