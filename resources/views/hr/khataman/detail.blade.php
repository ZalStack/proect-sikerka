{{-- resources/views/hr/khataman/detail.blade.php --}}
@extends('layouts.app')
...
<div class="flex min-h-screen">
    ...
    <div class="flex-1 transition-all duration-300 md:ml-64 pt-6">
        <div class="p-4 sm:p-6">
            <div class="mb-6">
                <h1 class="text-xl sm:text-2xl font-bold font-['Montserrat'] text-[#161758]">Detail Absensi Khataman</h1>
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm sm:text-base text-[#27438D]">{{ $absensi->tanggal->format('l') }}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Kode Input</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $absensi->kode_input ?? '-' }}</p>
                                </div>
                                <div>
