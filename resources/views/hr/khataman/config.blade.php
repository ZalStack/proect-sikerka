{{-- resources/views/hr/khataman/config.blade.php --}}
@extends('layouts.app')
            ...
            <div class="p-3 sm:p-6">
                <div class="mb-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <h1 class="text-xl sm:text-2xl font-bold font-['Montserrat'] text-[#161758]">⚙️ Pengaturan Jadwal Khataman</h1>
                            <p class="text-sm sm:text-base text-[#27438D]">Atur hari dan jam terakhir absensi Khataman</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
                    <form action="{{ route('hr.khataman.config.update') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Pilih hari pelaksanaan kegiatan Khataman.</p>
                        </div>
