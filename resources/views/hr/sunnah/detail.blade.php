{{-- views/hr/sunnah/detail.blade.php --}}
@extends('layouts.app')
                        ...
                        <div>
                            ...
                            <div class="space-y-2 sm:space-y-3">
                                <div>
                                    ...
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $sunnah->karyawan->nama_lengkap }}</p>
                                </div>
                                <div>
                                    <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Kode Pegawai</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $sunnah->karyawan->kode_pegawai }}</p>
                                </div>
                                <div>
                                    <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Divisi</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $sunnah->karyawan->divisi ?? '-' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-2 sm:space-y-3">
                                <div>
                                    ...
                                    <p class="text-sm sm:text-base text-[#27438D]">{{ $sunnah->tanggal->format('d-m-Y') }}</p>
                                </div>
                                <div>
                                    <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Total Poin</label>
                                    <p class="text-xl sm:text-2xl font-bold text-[#161758]">{{ $sunnah->total_poin }}</p>
                                </div>
                                <div>
