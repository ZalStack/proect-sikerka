                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        @foreach ($contacts as $contact)
                            <a href="{{ route('hr.pengumuman.send-whatsapp-number', ['id' => $pengumuman->id, 'phone' => $contact['phone']]) }}"
                                ...
                                <div
                                    class="w-12 h-12 rounded-full bg-[#25D366] flex items-center justify-center text-white font-bold text-xl">
                                ...
                                <svg class="w-5 h-5 text-[#25D366] opacity-0 group-hover:opacity-100 transition-opacity duration-200"
