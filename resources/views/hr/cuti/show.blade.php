        ...
        <div class="p-4 sm:p-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                    ...
                    <p class="text-[#27438D] text-sm sm:text-base">Informasi lengkap pengajuan cuti</p>
                </div>
                <a href="{{ route('hr.cuti.index') }}"
                   class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors text-sm sm:text-base">
                    Kembali
                </a>
            </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <form action="{{ route('hr.cuti.approve', $cuti->id) }}" method="POST" class="inline">
                            ...
                            <button type="submit" class="bg-[#2E7D3E] text-white px-6 py-2 rounded-lg hover:bg-green-700 transition-colors text-sm sm:text-base">
                                Setujui
                            </button>
                        </form>
                        <form action="{{ route('hr.cuti.approve', $cuti->id) }}" method="POST" class="inline">
                            ...
                            <button type="submit" class="bg-[#ec1d1d] text-white px-6 py-2 rounded-lg hover:bg-red-700 transition-colors text-sm sm:text-base">
                                Tolak
                            </button>
                        </form>
                    </div>
