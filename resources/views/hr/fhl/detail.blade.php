...
<div class="flex">
    ...
    <div class="ml-64 flex-1 p-6">
        <div class="mb-6">
            <h1 class="text-2xl font-bold font-['Montserrat'] text-[#161758]">Detail Absensi FHL</h1>
            <p class="text-[#27438D]">Informasi lengkap absensi FHL</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div>
                                ...
                                <p class="text-[#27438D]">{{ $absensi->karyawan->kode_pegawai }}</p>
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div>
                                <label class="text-sm text-[#1B1B1B] font-medium">Hari</label>
                                <p class="text-[#27438D]">Jumat</p>
                            </div>
                            <div>
                                <label class="text-sm text-[#1B1B1B] font-medium">Check-in</label>
                                <p class="text-[#27438D]">{{ $absensi->check_in ? Carbon\Carbon::parse($absensi->check_in)->format('H:i:s') : '-' }}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                <label class="text-sm text-[#1B1B1B] font-medium">IP Address</label>
                                <p class="text-[#27438D]">{{ $absensi->ip_address ?? '-' }}</p>
                            </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <h3 class="text-lg font-semibold text-[#161758] mb-4">📷 Bukti Foto</h3>
                    <div class="bg-[#F5F5F5] rounded-lg p-4 inline-block">
