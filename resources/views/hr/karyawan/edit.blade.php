                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-[10px] sm:text-xs text-[#27438D] mt-1">* Posisi akan otomatis ditentukan berdasarkan divisi (HRD = HR, lainnya = Karyawan)</p>
                                @error('divisi')
                                    <p class="mt-1 text-xs sm:text-sm text-[#ec1d1d]">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="sedang_melanjutkan_pendidikan" value="{{ old('sedang_melanjutkan_pendidikan', $karyawan->sedang_melanjutkan_pendidikan) }}"
