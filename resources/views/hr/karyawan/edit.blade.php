                ...
                <div class="p-6 bg-gradient-to-r from-[#f8faff] to-white border-b border-gray-200">
                    <div class="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
                        <div class="flex-shrink-0">
                            ...
                            @else
                                <div
                                    class="w-24 h-24 sm:w-32 sm:h-32 rounded-full {{ $karyawan->is_resigned ? 'bg-red-500' : 'bg-[#00a2e9]' }} flex items-center justify-center text-white text-3xl sm:text-4xl font-bold">
                                    {{ strtoupper(substr($karyawan->nama_lengkap, 0, 1)) }}
                                </div>
                            @endif
                        </div>
                        <div class="flex-1 text-center md:text-left">
                            <h2 class="text-xl sm:text-2xl font-bold text-[#161758] break-words">
                                {{ $karyawan->nama_lengkap }}</h2>
                            ...
                            <div class="flex flex-wrap items-center gap-2 mt-2 justify-center md:justify-start">
                                <span
                                    class="inline-block px-2 sm:px-3 py-1 rounded-full text-[10px] sm:text-sm font-medium {{ $karyawan->status_badge }}">
                                    {{ $karyawan->status_label }}
                                </span>
                                <span
                                    class="inline-block px-2 sm:px-3 py-1 rounded-full text-[10px] sm:text-sm font-medium {{ $karyawan->posisi === 'hr' ? 'bg-[#27438D] text-white' : 'bg-[#00a2e9] text-white' }}">
                                ...
                                @if ($karyawan->is_resigned)
                                    <span
                                        class="inline-block px-2 sm:px-3 py-1 rounded-full text-[10px] sm:text-sm font-medium bg-red-500 text-white animate-pulse">
                                        ⚠️ Resign
                                    </span>
                                @endif
                            </div>
                            @if ($karyawan->is_resigned)
                                <p class="text-xs sm:text-sm text-red-500 mt-2">
                                    ...
                                    {{ $karyawan->tanggal_resign ? $karyawan->tanggal_resign->format('d-m-Y') : '-' }}
                                </p>
                            @endif
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">ID Karyawan</label>
                                <p class="text-sm sm:text-base text-[#27438D] font-semibold break-words">
                                    {{ $karyawan->kode_pegawai }}</p>
                            </div>
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Nama Lengkap</label>
                                <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->nama_lengkap }}
                                </p>
                            </div>
                            ...
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">No KK</label>
                                <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->no_kk ?? '-' }}
                                </p>
                            </div>
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Agama</label>
                                <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->agama ?? '-' }}
                                </p>
                            </div>
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Status Pernikahan</label>
                                <p class="text-sm sm:text-base text-[#27438D] break-words">
                                    {{ $karyawan->status_pernikahan ?? '-' }}</p>
                            </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Divisi</label>
                                <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->divisi ?? '-' }}
                                </p>
                            </div>
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Posisi</label>
                                <p class="text-sm sm:text-base text-[#27438D]"><span
                                        class="px-2 py-1 rounded-full text-xs font-medium {{ $karyawan->posisi === 'hr' ? 'bg-[#27438D] text-white' : 'bg-[#00a2e9] text-white' }}">{{ $karyawan->posisi === 'hr' ? 'HR' : 'Karyawan' }}</span>
                                </p>
                            </div>
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Status Karyawan</label>
                                <p class="text-sm sm:text-base text-[#27438D]"><span
                                        class="px-2 py-1 rounded-full text-xs font-medium {{ $karyawan->status_badge }}">{{ $karyawan->status_label }}</span>
                                </p>
                            </div>
                            ...
                            @if ($karyawan->end_date)
                                <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Tanggal Berakhir</label>
                                    <p class="text-sm sm:text-base text-[#27438D]">
                                        {{ $karyawan->end_date->format('d-m-Y') }}</p>
                                </div>
                            @endif
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Tanggal Pengangkatan Karyawan
                                    Tetap</label>
                                <p class="text-sm sm:text-base text-[#27438D]">
                                    {{ $karyawan->tanggal_pengangkatan_tetap ? $karyawan->tanggal_pengangkatan_tetap->format('d-m-Y') : '-' }}
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                <div class="mb-2"><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Sedang
                                    ...
                                    <p class="text-sm sm:text-base text-[#27438D] font-semibold">
                                        {{ $karyawan->is_continuing_education ? 'Iya' : 'Tidak' }}</p>
                                </div>
                                <div class="mb-2"><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Program
                                        Pendidikan</label>
                                    <p class="text-sm sm:text-base text-[#27438D]">
                                        {{ $karyawan->is_continuing_education ? $karyawan->continuing_program ?? '-' : '-' }}
                                    </p>
                                </div>
                                <div class="mb-2"><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Perguruan
                                        Tinggi</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">
                                        {{ $karyawan->is_continuing_education ? $karyawan->continuing_perguruan_tinggi ?? '-' : '-' }}
                                    </p>
                                </div>
                                <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Jurusan / Program
                                        Studi</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">
                                        {{ $karyawan->is_continuing_education ? $karyawan->continuing_jurusan ?? '-' : '-' }}
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div id="editForm" style="display: none;">
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                    <div class="p-6">
                        ...
                        <form action="{{ route('hr.karyawan.update', $karyawan->id) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">ID Karyawan <span
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Nama Lengkap <span
                                                class="text-[#ec1d1d]">*</span></label>
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Nama Ibu
                                            Kandung</label>
                                        <input type="text" name="nama_ibu_kandung"
                                            value="{{ old('nama_ibu_kandung', $karyawan->nama_ibu_kandung) }}"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                ...
                                <div>
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Status
                                            Pernikahan</label>
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Email <span
                                                class="text-[#ec1d1d]">*</span></label>
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Konfirmasi Password
                                            Baru</label>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="golongan_darah"
                                            ...
                                            <option value="">Pilih</option>
                                            <option value="A"
                                                {{ old('golongan_darah', $karyawan->golongan_darah) === 'A' ? 'selected' : '' }}>
                                                A</option>
                                            <option value="B"
                                                {{ old('golongan_darah', $karyawan->golongan_darah) === 'B' ? 'selected' : '' }}>
                                                B</option>
                                            <option value="AB"
                                                {{ old('golongan_darah', $karyawan->golongan_darah) === 'AB' ? 'selected' : '' }}>
                                                AB</option>
                                            <option value="O"
                                                {{ old('golongan_darah', $karyawan->golongan_darah) === 'O' ? 'selected' : '' }}>
                                                O</option>
                                        </select>
                                ...
                                <div class="md:col-span-2">
                                    <h3
                                        class="text-base sm:text-lg font-semibold text-[#161758] border-b-2 border-[#27438D] pb-2 mb-4 mt-4 flex items-center">
                                        <span
                                            class="bg-[#27438D] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs mr-2">2</span>
                                        Informasi Profesional
                                    </h3>
                                ...
                                <div>
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Jabatan <span
                                                class="text-[#ec1d1d]">*</span></label>
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Divisi <span
                                                class="text-[#ec1d1d]">*</span></label>
                                        <input type="text" name="divisi" id="divisi_input"
                                            value="{{ old('divisi', $karyawan->divisi) }}" required
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                        <p class="text-xs text-[#27438D] mt-1">* Jika diisi "HRD", posisi akan otomatis
                                            menjadi HR</p>
                                        @error('divisi')
                                            <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" id="posisi_display"
                                            value="{{ $karyawan->posisi === 'hr' ? 'HR' : 'Karyawan' }}" disabled
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100">
                                        <input type="hidden" name="posisi" id="posisi_hidden"
                                            value="{{ $karyawan->posisi }}">
                                        <p class="text-xs text-[#27438D] mt-1">* Posisi ditentukan otomatis berdasarkan
                                            divisi</p>
                                    </div>

                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Tanggal Pengangkatan
                                            Tetap</label>
                                ...
                                <div>
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Status <span
                                                class="text-[#ec1d1d]">*</span></label>
                                        <select name="status" required
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                            <option value="Karyawan Tetap"
                                                {{ old('status', $karyawan->status) === 'Karyawan Tetap' ? 'selected' : '' }}>
                                                Karyawan Tetap</option>
                                            <option value="Contract"
                                                {{ old('status', $karyawan->status) === 'Contract' ? 'selected' : '' }}>
                                                Kontrak</option>
                                            <option value="Internship"
                                                {{ old('status', $karyawan->status) === 'Internship' ? 'selected' : '' }}>
                                                Magang</option>
                                        </select>
                                        @error('status')
                                            <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Tanggal Bergabung
                                            <span class="text-[#ec1d1d]">*</span></label>
                                    ...
                                    <div class="mb-4">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <label for="is_resigned"
                                                class="text-xs sm:text-sm font-medium text-[#1B1B1B]">
                                                ☑️ Karyawan ini sudah resign
                                            </label>
                                        </div>
                                        <p class="text-xs text-[#27438D] mt-1">* Jika dicentang, akun karyawan akan
                                            dinonaktifkan dan tidak bisa login</p>
                                    </div>

                                    <div id="tanggal_resign_container"
                                        class="mb-4 {{ old('is_resigned', $karyawan->is_resigned) ? '' : 'hidden' }}">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Tanggal Resign <span
                                                class="text-[#ec1d1d]">*</span></label>
                                        <input type="date" name="tanggal_resign" id="tanggal_resign"
                                            ...
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                        <p class="text-xs text-[#27438D] mt-1">* Tanggal resign harus setelah tanggal
                                            bergabung</p>
                                ...
                                <div class="md:col-span-2">
                                    <h3
                                        class="text-base sm:text-lg font-semibold text-[#161758] border-b-2 border-[#FCC626] pb-2 mb-4 mt-4 flex items-center">
                                        <span
                                            class="bg-[#FCC626] text-[#1B1B1B] rounded-full w-6 h-6 flex items-center justify-center text-xs mr-2">3</span>
                                        Pendidikan
                                    </h3>
                                ...
                                <div>
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Pendidikan
                                            Terakhir</label>
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Perguruan
                                            Tinggi</label>
                                        <input type="text" name="perguruan_tinggi"
                                            value="{{ old('perguruan_tinggi', $karyawan->perguruan_tinggi) }}"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Jurusan / Program
                                            Studi</label>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" name="ipk_terakhir"
                                            value="{{ old('ipk_terakhir', $karyawan->ipk_terakhir) }}" step="0.01"
                                            min="0" max="4"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                        @error('ipk_terakhir')
                                            <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                                ...
                                <div>
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Sedang Melanjutkan
                                            Pendidikan?</label>
                                        <div class="flex flex-wrap items-center gap-4">
                                            <label class="inline-flex items-center">
                                                <input type="radio" name="is_continuing_education" value="1"
                                                    {{ old('is_continuing_education', $karyawan->is_continuing_education) == 1 ? 'checked' : '' }}
                                            ...
                                            <label class="inline-flex items-center">
                                                <input type="radio" name="is_continuing_education" value="0"
                                                    {{ old('is_continuing_education', $karyawan->is_continuing_education) == 0 ? 'checked' : '' }}
                                                    class="w-4 h-4 text-[#27438D] border-gray-300 focus:ring-[#27438D]">
                                    ...
                                    <div id="continuing_fields"
                                        style="{{ old('is_continuing_education', $karyawan->is_continuing_education) ? '' : 'display: none;' }}">
                                        <div class="mb-4">
                                            <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Program
                                                Pendidikan</label>
                                            <select name="continuing_program"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                                <option value="">Pilih</option>
                                                <option value="D3"
                                                    {{ old('continuing_program', $karyawan->continuing_program) === 'D3' ? 'selected' : '' }}>
                                                    D3</option>
                                                <option value="D4/S1"
                                                    {{ old('continuing_program', $karyawan->continuing_program) === 'D4/S1' ? 'selected' : '' }}>
                                                    D4/S1</option>
                                                <option value="S2"
                                                    {{ old('continuing_program', $karyawan->continuing_program) === 'S2' ? 'selected' : '' }}>
                                                    S2</option>
                                                <option value="S3"
                                                    {{ old('continuing_program', $karyawan->continuing_program) === 'S3' ? 'selected' : '' }}>
                                                    S3</option>
                                            </select>
                                        ...
                                        <div class="mb-4">
                                            <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Perguruan
                                                Tinggi</label>
                                            <input type="text" name="continuing_perguruan_tinggi"
                                                value="{{ old('continuing_perguruan_tinggi', $karyawan->continuing_perguruan_tinggi) }}"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                        ...
                                        <div class="mb-4">
                                            <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Jurusan / Program
                                                Studi</label>
                                            <input type="text" name="continuing_jurusan"
                                                value="{{ old('continuing_jurusan', $karyawan->continuing_jurusan) }}"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                ...
                                <div class="md:col-span-2">
                                    <h3
                                        class="text-base sm:text-lg font-semibold text-[#161758] border-b-2 border-[#2E7D3E] pb-2 mb-4 mt-4 flex items-center">
                                        <span
                                            class="bg-[#2E7D3E] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs mr-2">4</span>
                                        Kontak & Alamat
                                    </h3>
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Telepon Kontak
                                            Darurat</label>
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Nama Kontak
                                            Darurat</label>
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Alamat
                                            Domisili</label>
                                ...
                                <div class="md:col-span-2">
                                    <h3
                                        class="text-base sm:text-lg font-semibold text-[#161758] border-b-2 border-[#ec1d1d] pb-2 mb-4 mt-4 flex items-center">
                                        <span
                                            class="bg-[#ec1d1d] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs mr-2">5</span>
                                        Informasi Tambahan
                                    </h3>
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="file" name="foto_profil" accept="image/*"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                        @if ($karyawan->foto_profil)
                                            <div class="mt-2"><img src="{{ Storage::url($karyawan->foto_profil) }}"
                                                    alt="Foto Profil" class="w-20 h-20 rounded-full object-cover border">
                                            </div>
                                        @endif
                                        @error('foto_profil')
                                            <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                            ...
                            <div class="mt-6 flex flex-wrap gap-4">
                                <button type="submit"
                                    class="w-full sm:w-auto bg-[#27438D] text-white px-6 py-2 rounded-lg hover:bg-[#161758] transition-colors duration-200">Update
                                    Karyawan</button>
                                <button type="button" onclick="toggleEditForm()"
                                    class="w-full sm:w-auto bg-gray-500 text-white px-6 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-200">Batal</button>
                            </div>
                        </form>
                    </div>
                </div>
