            ...
            <form action="{{ route('hr.karyawan.update', $karyawan->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="divisi" id="divisi_select" required
                                ...
                                <option value="HRD" {{ old('divisi', $karyawan->divisi) === 'HRD' ? 'selected' : '' }}>
                                    HRD</option>
                                <option value="IT" {{ old('divisi', $karyawan->divisi) === 'IT' ? 'selected' : '' }}>
                                    IT</option>
                                <option value="KPD" {{ old('divisi', $karyawan->divisi) === 'KPD' ? 'selected' : '' }}>
                                    KPD</option>
                                <option value="LPS" {{ old('divisi', $karyawan->divisi) === 'LPS' ? 'selected' : '' }}>
                                    LPS</option>
                                <option value="MEDIA"
                                ...
                                <option value="PKA" {{ old('divisi', $karyawan->divisi) === 'PKA' ? 'selected' : '' }}>
                                    PKA</option>
                                <option value="RG" {{ old('divisi', $karyawan->divisi) === 'RG' ? 'selected' : '' }}>
                                    RG</option>
                                <option value="SAPRAS"
                                    {{ old('divisi', $karyawan->divisi) === 'SAPRAS' ? 'selected' : '' }}>SAPRAS</option>
                            </select>
                            <p class="text-xs text-[#27438D] mt-1">* Posisi akan otomatis ditentukan berdasarkan divisi
                                (HRD = HR, lainnya = Karyawan)</p>
                            @error('divisi')
                                <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" required
                                ...
                                <option value="Karyawan Tetap"
                                    {{ old('status', $karyawan->status) === 'Karyawan Tetap' ? 'selected' : '' }}>Karyawan
                                    Tetap</option>
                        ...
                        <!-- Status Resign -->
                        <div class="md:col-span-2">
                            <h3 class="text-lg font-semibold text-[#161758] border-b border-gray-200 pb-2 mb-4 mt-4">Status
                                Kepegawaian</h3>
                        </div>
                            ...
                            <div class="mb-4">
                                <div class="flex items-center space-x-3">
                                    <input type="checkbox" name="is_resigned" id="is_resigned" value="1"
                                        ...
                                        class="w-5 h-5 rounded text-[#ec1d1d] focus:ring-2 focus:ring-[#ec1d1d] transition-all duration-200">
                                    <label for="is_resigned" class="text-sm font-medium text-[#1B1B1B]">
                                        ☑️ Karyawan ini sudah resign
                                    </label>
                                </div>
                                <p class="text-xs text-[#27438D] mt-1">* Jika dicentang, akun karyawan akan dinonaktifkan
                                    dan tidak bisa login</p>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="ipk_terakhir"
                                value="{{ old('ipk_terakhir', $karyawan->ipk_terakhir) }}" step="0.01" min="0"
                                max="4"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                            @error('ipk_terakhir')
                                <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
