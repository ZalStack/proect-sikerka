                ...
                <form action="{{ route('hr.karyawan.update', $karyawan->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <!-- Nama Lengkap -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Nama Lengkap <span
                                        class="text-[#ec1d1d]">*</span></label>
                            ...
                            <!-- Tanggal Lahir -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Tanggal
                                    Lahir</label>
                            ...
                            <!-- Jenis Kelamin -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Jenis
                                    Kelamin</label>
                            ...
                            <!-- Nama Ibu Kandung -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Nama Ibu
                                    Kandung</label>
                        ...
                        <div>
                            <!-- Status Pernikahan -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Status
                                    Pernikahan</label>
                            ...
                            <!-- Email -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Email <span
                                        class="text-[#ec1d1d]">*</span></label>
                            ...
                            <!-- Password Baru -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Password
                                    Baru</label>
                                <input type="password" name="password"
                                    class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                <p class="text-[10px] sm:text-xs text-gray-500 mt-1">Kosongkan jika tidak ingin mengubah
                                    password</p>
                                @error('password')
                                    <p class="mt-1 text-xs sm:text-sm text-[#ec1d1d]">{{ $message }}</p>
                                @enderror
                            ...
                            <!-- Konfirmasi Password -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Konfirmasi Password
                                    Baru</label>
                            ...
                            <!-- Golongan Darah -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Golongan
                                    Darah</label>
                                <select name="golongan_darah"
                                    class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                    <option value="">Pilih</option>
                                    <option value="A"
                                        {{ old('golongan_darah', $karyawan->golongan_darah) === 'A' ? 'selected' : '' }}>A
                                    </option>
                                    <option value="B"
                                        {{ old('golongan_darah', $karyawan->golongan_darah) === 'B' ? 'selected' : '' }}>B
                                    </option>
                                    <option value="AB"
                                        {{ old('golongan_darah', $karyawan->golongan_darah) === 'AB' ? 'selected' : '' }}>
                                        AB</option>
                                    <option value="O"
                                        {{ old('golongan_darah', $karyawan->golongan_darah) === 'O' ? 'selected' : '' }}>O
                                    </option>
                                </select>
                        ...
                        <div class="md:col-span-2">
                            <h3
                                class="text-base sm:text-lg font-semibold text-[#161758] border-b border-gray-200 pb-2 mb-4 mt-4">
                                Informasi Profesional</h3>
                        </div>
                        ...
                        <div>
                            <!-- Jabatan -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Jabatan <span
                                        class="text-[#ec1d1d]">*</span></label>
                            ...
                            <!-- Divisi -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Divisi <span
                                        class="text-[#ec1d1d]">*</span></label>
                                <select name="divisi" id="divisi_select" required
                                    class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                    <option value="">Pilih Divisi</option>
                                    <option value="HRD"
                                        {{ old('divisi', $karyawan->divisi) === 'HRD' ? 'selected' : '' }}>HRD</option>
                                    <option value="IT"
                                    ...
                                    <option value="MEDIA"
                                        {{ old('divisi', $karyawan->divisi) === 'MEDIA' ? 'selected' : '' }}>MEDIA</option>
                                    <option value="PENDIDIKAN"
                                        {{ old('divisi', $karyawan->divisi) === 'PENDIDIKAN' ? 'selected' : '' }}>
                                        PENDIDIKAN</option>
                                    <option value="PKA"
                                        {{ old('divisi', $karyawan->divisi) === 'PKA' ? 'selected' : '' }}>PKA</option>
                                    <option value="RG"
                                        {{ old('divisi', $karyawan->divisi) === 'RG' ? 'selected' : '' }}>RG</option>
                                    <option value="SAPRAS"
                                        {{ old('divisi', $karyawan->divisi) === 'SAPRAS' ? 'selected' : '' }}>SAPRAS
                                    </option>
                                </select>
                                <p class="text-[10px] sm:text-xs text-[#27438D] mt-1">* Posisi akan otomatis ditentukan
                                    berdasarkan divisi (HRD = HR, lainnya = Karyawan)</p>
                                @error('divisi')
                                    <p class="mt-1 text-xs sm:text-sm text-[#ec1d1d]">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-[10px] sm:text-xs text-[#27438D] mt-1">* Posisi ditentukan otomatis
                                    berdasarkan divisi</p>
                            </div>
                        </div>
                        ...
                        <div>
                            <!-- Status Karyawan -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Status <span
                                        class="text-[#ec1d1d]">*</span></label>
                                <select name="status" required
                                    ...
                                    <option value="Contract"
                                        {{ old('status', $karyawan->status) === 'Contract' ? 'selected' : '' }}>Kontrak
                                    </option>
                                    <option value="Internship"
                                        {{ old('status', $karyawan->status) === 'Internship' ? 'selected' : '' }}>Magang
                                    </option>
                                </select>
                                @error('status')
                                    <p class="mt-1 text-xs sm:text-sm text-[#ec1d1d]">{{ $message }}</p>
                            ...
                            <!-- Tanggal Bergabung -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Tanggal Bergabung
                            ...
                            <div class="md:col-span-2">
                                <div class="mb-4">
                                    ...
                                    <p class="text-[10px] sm:text-xs text-[#27438D] mt-1">* Jika dicentang, akun karyawan
                                        akan dinonaktifkan dan tidak bisa login</p>
                                </div>

                                <!-- Tanggal Resign (Muncul jika checkbox dicentang) -->
                                <div id="tanggal_resign_container"
                                    class="mb-4 {{ old('is_resigned', $karyawan->is_resigned) ? '' : 'hidden' }}">
                                    <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Tanggal Resign
                                        <span class="text-[#ec1d1d]">*</span></label>
                                    <input type="date" name="tanggal_resign" id="tanggal_resign"
                                        ...
                                        class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                    <p class="text-[10px] sm:text-xs text-[#27438D] mt-1">* Tanggal resign harus setelah
                                        tanggal bergabung</p>
                        ...
                        <div>
                            <!-- Pendidikan Terakhir -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Pendidikan
                                    Terakhir</label>
                            ...
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Sedang Melanjutkan
                                    Pendidikan</label>
                                <input type="text" name="sedang_melanjutkan_pendidikan"
                                    ...
                                    class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                @error('sedang_melanjutkan_pendidikan')
                                    <p class="mt-1 text-xs sm:text-sm text-[#ec1d1d]">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <!-- IPK Terakhir -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">IPK
                                    Terakhir</label>
                        ...
                        <div>
                            <!-- Perguruan Tinggi -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Perguruan
                                    Tinggi</label>
                            ...
                            <!-- Jurusan -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Jurusan</label>
                            ...
                            <!-- Tahun Lulus -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Tahun Lulus</label>
                        ...
                        <div>
                            <!-- Nomor Telepon -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Nomor
                                    Telepon</label>
                            ...
                            <!-- Nama Kontak Darurat -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Nama Kontak
                                    Darurat</label>
                        ...
                        <div>
                            ...
                            <!-- Alamat Domisili -->
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Alamat Domisili
                                    Saat Ini</label>
                            ...
                            <div class="mb-4">
                                <label class="block text-xs sm:text-sm font-medium text-[#1B1B1B] mb-1">Telepon Kontak
                                    Darurat</label>
