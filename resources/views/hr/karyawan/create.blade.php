            ...
            <form action="{{ route('hr.karyawan.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status_pernikahan"
                                ...
                                <option value="Menikah" {{ old('status_pernikahan') === 'Menikah' ? 'selected' : '' }}>
                                    Menikah</option>
                                <option value="Cerai" {{ old('status_pernikahan') === 'Cerai' ? 'selected' : '' }}>Cerai
                                </option>
                            </select>
                        ...
                        <!-- Password -->
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Password <span
                                    class="text-[#ec1d1d]">*</span></label>
                        ...
                        <!-- Konfirmasi Password -->
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Konfirmasi Password <span
                                    class="text-[#ec1d1d]">*</span></label>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="divisi" id="divisi_select" required
                                ...
                                <option value="KPJ" {{ old('divisi') === 'KPJ' ? 'selected' : '' }}>KPJ</option>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" required
                                ...
                                <option value="Contract" {{ old('status') === 'Contract' ? 'selected' : '' }}>Kontrak
                                </option>
                                <option value="Internship" {{ old('status') === 'Internship' ? 'selected' : '' }}>Magang
                                </option>
                            </select>
                            @error('status')
                                <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="pendidikan_terakhir_new"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                <option value="">Pilih</option>
                                <option value="SMP" {{ old('pendidikan_terakhir_new') === 'SMP' ? 'selected' : '' }}>
                                    SMP</option>
                                <option value="SMA/MA"
                                    {{ old('pendidikan_terakhir_new') === 'SMA/MA' ? 'selected' : '' }}>SMA/MA</option>
                                <option value="SMK" {{ old('pendidikan_terakhir_new') === 'SMK' ? 'selected' : '' }}>
                                    SMK</option>
                                <option value="D1" {{ old('pendidikan_terakhir_new') === 'D1' ? 'selected' : '' }}>D1
                                </option>
                                <option value="D2" {{ old('pendidikan_terakhir_new') === 'D2' ? 'selected' : '' }}>D2
                                </option>
                                <option value="D3" {{ old('pendidikan_terakhir_new') === 'D3' ? 'selected' : '' }}>D3
                                </option>
                                <option value="D4" {{ old('pendidikan_terakhir_new') === 'D4' ? 'selected' : '' }}>D4
                                </option>
                                <option value="S1" {{ old('pendidikan_terakhir_new') === 'S1' ? 'selected' : '' }}>S1
                                </option>
                                <option value="S2" {{ old('pendidikan_terakhir_new') === 'S2' ? 'selected' : '' }}>S2
                                </option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="sedang_melanjutkan_pendidikan"
                                value="{{ old('sedang_melanjutkan_pendidikan') }}" placeholder="Contoh: S2 Manajemen"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="ipk_terakhir" value="{{ old('ipk_terakhir') }}" step="0.01"
                                min="0" max="4"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                            @error('ipk_terakhir')
                                <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="tahun_lulus" value="{{ old('tahun_lulus') }}" min="1900"
                                max="{{ date('Y') }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                            @error('tahun_lulus')
                                <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="telepon_kontak_darurat"
                                value="{{ old('telepon_kontak_darurat') }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="tanggal_pengangkatan_tetap"
                                value="{{ old('tanggal_pengangkatan_tetap') }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
