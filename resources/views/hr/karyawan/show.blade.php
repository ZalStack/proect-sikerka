        ...
        <div class="p-4 sm:p-6">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <!-- Kategori: Informasi Profesional (Tanggal Pengangkatan Tetap dipindah ke sini) -->
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <p class="text-sm sm:text-base text-[#27438D]">{{ $karyawan->is_continuing_education ? ($karyawan->continuing_program ?? '-') : '-' }}</p>
                                </div>
                                <div class="mb-2">
                                    <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Perguruan Tinggi</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->is_continuing_education ? ($karyawan->continuing_perguruan_tinggi ?? '-') : '-' }}</p>
                                </div>
                                <div>
                                    <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Jurusan / Program Studi</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->is_continuing_education ? ($karyawan->continuing_jurusan ?? '-') : '-' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
