            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="p-6">
                    <div class="flex items-center space-x-6 mb-6">
                        @if ($karyawan->foto_profil)
                            <img src="{{ Storage::url($karyawan->foto_profil) }}" alt="Foto"
                                class="w-32 h-32 rounded-full object-cover border-4 border-[#00a2e9]">
                        @else
                            <div
                                class="w-32 h-32 rounded-full bg-[#00a2e9] flex items-center justify-center text-white text-4xl font-bold">
                        ...
                        <div>
                            ...
                            <span
                                class="inline-block px-3 py-1 rounded-full text-sm font-medium mt-2 {{ $karyawan->status === 'Full-time' ? 'bg-[#2E7D3E] text-white' : ($karyawan->status === 'Contract' ? 'bg-[#FCC626] text-[#1B1B1B]' : 'bg-[#00a2e9] text-white') }}">
                                {{ $karyawan->status }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            <h3 class="text-lg font-semibold text-[#161758] border-b border-gray-200 pb-2">Informasi Pribadi
                            </h3>
                            <div>
                                <label class="text-sm text-[#1B1B1B] font-medium">NIP</label>
                                <p class="text-[#27438D]">{{ $karyawan->nip }}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="text-[#27438D]">{{ $karyawan->tempat_lahir }},
                                    {{ $karyawan->tanggal_lahir->format('d-m-Y') }}</p>
                            </div>
                            <div>
                        ...
                        <div class="space-y-4">
                            <h3 class="text-lg font-semibold text-[#161758] border-b border-gray-200 pb-2">Informasi
                                Profesional</h3>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="text-[#27438D]">{{ $karyawan->tanggal_bergabung->format('d-m-Y') }}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-[#27438D]">{{ $karyawan->total_hari_kerja }}</p>
                            </div>
                            ...
                            @endif
                            <div>
                                <label class="text-sm text-[#1B1B1B] font-medium">Role</label>
                                <p class="text-[#27438D]">{{ ucfirst($karyawan->role) }}</p>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2 space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-[#27438D]">
                                        {{ $karyawan->pendidikan_terakhir_new ?? ($karyawan->pendidikan_terakhir ?? '-') }}
                                    </p>
                                </div>
                                <div>
                                    <label class="text-sm text-[#1B1B1B] font-medium">Universitas</label>
                                    <p class="text-[#27438D]">{{ $karyawan->universitas ?? '-' }}</p>
                                </div>
                                <div>
                        ...
                        <div class="md:col-span-2 space-y-4">
                            <h3 class="text-lg font-semibold text-[#161758] border-b border-gray-200 pb-2">Kontak & Alamat
                            </h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                        ...
                        <!-- Di bagian Informasi Pribadi, tambahkan -->
                        <div>
                        ...
                        <div>
                            <label class="text-sm text-[#1B1B1B] font-medium">Gelar Pendidikan</label>
                            <p class="text-[#27438D]">{{ $karyawan->gelar_pendidikan ?? '-' }}</p>
                        </div>
                        <div>
                        ...
                        <!-- Di bagian Informasi Profesional, tambahkan Divisi -->
                        <div>
