                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Jenis Kelamin</label>
                                    <p class="text-sm sm:text-base text-[#27438D]">{{ $karyawan->jenis_kelamin ?? '-' }}
                                    </p>
                                </div>
                                ...
                                <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">NIK</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->nik ?? '-' }}
                                    </p>
                                </div>
                                ...
                                <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Golongan Darah</label>
                                    <p class="text-sm sm:text-base text-[#27438D]">{{ $karyawan->golongan_darah ?? '-' }}
                                    </p>
                                </div>
                                <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">NPWP</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->npwp ?? '-' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                @if ($karyawan->end_date)
                                    <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Tanggal
                                            Berakhir</label>
                                        <p class="text-sm sm:text-base text-[#27438D]">
                                ...
                                @endif
                                @if ($karyawan->is_resigned)
                                    <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Status Akun</label>
                                        <p class="text-sm sm:text-base text-[#27438D]"><span
                                                class="px-2 py-1 rounded-full text-xs font-medium bg-red-500 text-white">❌
                                                Tidak Aktif (Resign)</span></p>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                <div>
                                    <div class="mb-2">
                                        <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Pendidikan
                                            Terakhir</label>
                                        <p class="text-sm sm:text-base text-[#27438D] break-words">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <p class="text-sm sm:text-base text-[#27438D]">{{ $karyawan->ipk_terakhir ?? '-' }}
                                        </p>
                                    </div>
                                    <div>
                                        <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Tahun Lulus</label>
                                        <p class="text-sm sm:text-base text-[#27438D]">{{ $karyawan->tahun_lulus ?? '-' }}
                                        </p>
                                    </div>
                                </div>

                                <!-- Kolom Kanan: Sedang Melanjutkan Pendidikan (selalu ditampilkan) -->
                                <div>
                                    <div class="mb-2">
                                        ...
                                        <p class="text-sm sm:text-base text-[#27438D] font-semibold">
                                            {{ $karyawan->is_continuing_education ? 'Iya' : 'Tidak' }}
                                        </p>
                                    </div>
                                    <div class="mb-2">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Nama Kontak
                                        Darurat</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">
                                ...
                                <div class="md:col-span-2"><label
                                        class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Alamat Domisili</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">
