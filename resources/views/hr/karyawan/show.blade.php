                ...
                <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            @if($karyawan->is_continuing_education)
                                <div>
                                    ...
                                    <p class="text-sm sm:text-base text-[#27438D]">{{ $karyawan->continuing_program ?? '-' }}</p>
                                </div>
                                <div>
                                    <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Perguruan Tinggi</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->continuing_perguruan_tinggi ?? '-' }}</p>
                                </div>
                                <div>
                                    <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Jurusan / Program Studi</label>
                                    <p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->continuing_jurusan ?? '-' }}</p>
                                </div>
                            @endif
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Pendidikan Terakhir</label><p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->pendidikan_terakhir ?? '-' }}</p></div>
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Perguruan Tinggi</label><p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->perguruan_tinggi ?? '-' }}</p></div>
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Jurusan / Program Studi</label><p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->jurusan ?? '-' }}</p></div>
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">IPK Terakhir</label><p class="text-sm sm:text-base text-[#27438D]">{{ $karyawan->ipk_terakhir ?? '-' }}</p></div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div class="md:col-span-2"><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Alamat Sesuai KTP</label><p class="text-sm sm:text-base text-[#27438D] break-words">{{ $karyawan->alamat ?? '-' }}</p></div>
