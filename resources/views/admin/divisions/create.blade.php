...
@section('title', 'Tambah Divisi - E-Learning')
...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mt-2">Tambah Divisi</h1>
        <p class="text-gray-600 mt-1">Tambahkan divisi baru</p>
    </div>
