...
@section('title', 'Edit Quiz - E-Learning')
...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mt-2">Edit Quiz</h1>
        <p class="text-gray-600 mt-1">Perbarui data quiz</p>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description"
                              name="description"
                              rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $quiz->description) }}</textarea>
                </div>
                ...
                <div class="space-y-3">
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="is_random_questions" value="1" {{ old('is_random_questions', $quiz->is_random_questions) ? 'checked' : '' }}>
