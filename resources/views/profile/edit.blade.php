        ...
        <div class="ml-64 flex-1 p-6">
            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_belakang" value="{{ old('nama_belakang', $user->nama_belakang) }}"
                            required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                        @error('nama_belakang')
                            <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                    ...
                    <!-- Tambahkan di Informasi Pribadi -->
                    <div>
                        ...
                        <select name="golongan_darah"
                            ...
                            <option value="AB"
                                {{ old('golongan_darah', $user->golongan_darah) === 'AB' ? 'selected' : '' }}>AB</option>
                            <option value="O"
                    ...
                    <div>
                        ...
                        <input type="text" name="gelar_pendidikan"
                            value="{{ old('gelar_pendidikan', $user->gelar_pendidikan) }}"
                    ...
                    <!-- Di Informasi Profesional, tambahkan Divisi -->
                    <div>
                        ...
                        @if ($isHr)
                            <select name="divisi"
                                ...
                                <option value="MEDIA" {{ old('divisi', $user->divisi) === 'MEDIA' ? 'selected' : '' }}>
                                    MEDIA</option>
                                <option value="KPD" {{ old('divisi', $user->divisi) === 'KPD' ? 'selected' : '' }}>KPD
                                </option>
                                <option value="IT" {{ old('divisi', $user->divisi) === 'IT' ? 'selected' : '' }}>IT
                                </option>
                                <option value="HRD" {{ old('divisi', $user->divisi) === 'HRD' ? 'selected' : '' }}>HRD
                                </option>
                                <option value="LPS" {{ old('divisi', $user->divisi) === 'LPS' ? 'selected' : '' }}>LPS
                                </option>
                                <option value="PKA" {{ old('divisi', $user->divisi) === 'PKA' ? 'selected' : '' }}>PKA
                                </option>
                                <option value="RG" {{ old('divisi', $user->divisi) === 'RG' ? 'selected' : '' }}>RG
                                </option>
                                <option value="SAPRAS" {{ old('divisi', $user->divisi) === 'SAPRAS' ? 'selected' : '' }}>
                                    SAPRAS</option>
                    ...
                    @if ($isHr)
                        ...
                        <div>
                            ...
                            <select name="status" required
                                ...
                                <option value="Full-time"
                                    {{ old('status', $user->status) === 'Full-time' ? 'selected' : '' }}>Full-time</option>
                                <option value="Contract"
                                    {{ old('status', $user->status) === 'Contract' ? 'selected' : '' }}>Contract</option>
                                <option value="Internship"
                                    {{ old('status', $user->status) === 'Internship' ? 'selected' : '' }}>Internship
                                </option>
                            </select>
                            @error('status')
                                <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_bergabung"
                                value="{{ old('tanggal_bergabung', $user->tanggal_bergabung->format('Y-m-d')) }}" required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                    ...
                    @else
                        <!-- Karyawan tidak bisa edit jabatan, status, tanggal bergabung -->
                        <div>
                            <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Jabatan</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Tanggal Bergabung</label>
                            <input type="text" value="{{ $user->tanggal_bergabung->format('d-m-Y') }}" disabled
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100">
                        </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="tahun_lulus" value="{{ old('tahun_lulus', $user->tahun_lulus) }}"
                            min="1900" max="{{ date('Y') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <form action="{{ route('profile.update-password') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Password Saat Ini</label>
