        ...
        <div class="flex-1 transition-all duration-300 md:ml-64 p-3 sm:p-6">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 mb-6">
                ...
                <div class="p-6">
                    ...
                    <!-- Kategori: Pendidikan (diperbaiki urutannya) -->
                    <div class="mb-8">
                        <h3
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <div class="mb-2">
                                    <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Jurusan / Program
                                        Studi</label>
                            ...
                            <div>
                                <div class="mb-2">
                                    <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Sedang Melanjutkan
                                        Pendidikan?</label>
                                ...
                                @if ($user->is_continuing_education)
                                    <div class="mb-2">
                                        <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Program
                                            Pendidikan</label>
                                        <p class="text-sm sm:text-base text-[#27438D]">
                                            {{ $user->continuing_program ?? '-' }}</p>
                                    </div>
                                    <div class="mb-2">
                                        <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Perguruan
                                            Tinggi</label>
                                        <p class="text-sm sm:text-base text-[#27438D] break-words">
                                            {{ $user->continuing_perguruan_tinggi ?? '-' }}</p>
                                    </div>
                                    <div>
                                        <label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Jurusan / Program
                                            Studi</label>
                                        <p class="text-sm sm:text-base text-[#27438D] break-words">
                                            {{ $user->continuing_jurusan ?? '-' }}</p>
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div class="md:col-span-2"><label
                                    class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Alamat</label>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            <div><label class="text-xs sm:text-sm text-[#1B1B1B] font-medium">Tanggal Pengangkatan
                                    Tetap</label>
                                <p class="text-sm sm:text-base text-[#27438D]">
                    ...
                    <div class="p-6">
                        ...
                        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="kode_pegawai"
                                            value="{{ old('kode_pegawai', $user->kode_pegawai) }}" readonly
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="nama_ibu_kandung"
                                            value="{{ old('nama_ibu_kandung', $user->nama_ibu_kandung) }}"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                ...
                                <div>
                                    <div class="mb-4">
                                        ...
                                        <select name="status_pernikahan"
                                            ...
                                            <option value="Belum Menikah"
                                                {{ old('status_pernikahan', $user->status_pernikahan) === 'Belum Menikah' ? 'selected' : '' }}>
                                                Belum Menikah</option>
                                            <option value="Menikah"
                                                {{ old('status_pernikahan', $user->status_pernikahan) === 'Menikah' ? 'selected' : '' }}>
                                                Menikah</option>
                                            <option value="Cerai"
                                                {{ old('status_pernikahan', $user->status_pernikahan) === 'Cerai' ? 'selected' : '' }}>
                                                Cerai</option>
                                        </select>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" name="jumlah_anak"
                                            value="{{ old('jumlah_anak', $user->jumlah_anak ?? 0) }}" min="0"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                        @error('jumlah_anak')
                                            <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="golongan_darah"
                                            ...
                                            <option value="">Pilih</option>
                                            <option value="A"
                                                {{ old('golongan_darah', $user->golongan_darah) === 'A' ? 'selected' : '' }}>
                                                A</option>
                                            <option value="B"
                                                {{ old('golongan_darah', $user->golongan_darah) === 'B' ? 'selected' : '' }}>
                                                B</option>
                                            <option value="AB"
                                                {{ old('golongan_darah', $user->golongan_darah) === 'AB' ? 'selected' : '' }}>
                                                AB</option>
                                            <option value="O"
                                                {{ old('golongan_darah', $user->golongan_darah) === 'O' ? 'selected' : '' }}>
                                                O</option>
                                        </select>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="status" required
                                            ...
                                            <option value="Karyawan Tetap"
                                                {{ old('status', $user->status) === 'Karyawan Tetap' ? 'selected' : '' }}>
                                                Karyawan Tetap</option>
                                            <option value="Contract"
                                                {{ old('status', $user->status) === 'Contract' ? 'selected' : '' }}>Kontrak
                                            </option>
                                            <option value="Internship"
                                                {{ old('status', $user->status) === 'Internship' ? 'selected' : '' }}>
                                                Magang</option>
                                        </select>
                                        @error('status')
                                            <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                                ...
                                <!-- Pendidikan (diperbaiki urutan dan posisi) -->
                                <div class="md:col-span-2">
                                    <h3
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="perguruan_tinggi"
                                            value="{{ old('perguruan_tinggi', $user->perguruan_tinggi) }}"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" name="ipk_terakhir"
                                            value="{{ old('ipk_terakhir', $user->ipk_terakhir) }}" step="0.01"
                                            min="0" max="4"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                        @error('ipk_terakhir')
                                            <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" name="tahun_lulus"
                                            value="{{ old('tahun_lulus', $user->tahun_lulus) }}" min="1900"
                                            max="{{ date('Y') }}"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                        @error('tahun_lulus')
                                            <p class="mt-1 text-sm text-[#ec1d1d]">{{ $message }}</p>
                                        ...
                                        <div class="flex flex-wrap items-center gap-4">
                                            <label class="inline-flex items-center">
                                                <input type="radio" name="is_continuing_education" value="1"
                                                    {{ old('is_continuing_education', $user->is_continuing_education) ? 'checked' : '' }}
                                            ...
                                            <label class="inline-flex items-center">
                                                <input type="radio" name="is_continuing_education" value="0"
                                                    {{ old('is_continuing_education', $user->is_continuing_education) === false ? 'checked' : '' }}
                                                    class="w-4 h-4 text-[#27438D] border-gray-300 focus:ring-[#27438D]">
                                    ...
                                    <div id="continuing_fields">
                                        <div class="mb-4">
                                            ...
                                            <select name="continuing_program"
                                                ...
                                                <option value="">Pilih</option>
                                                <option value="D3"
                                                    {{ old('continuing_program', $user->continuing_program) === 'D3' ? 'selected' : '' }}>
                                                    D3</option>
                                                <option value="D4/S1"
                                                    {{ old('continuing_program', $user->continuing_program) === 'D4/S1' ? 'selected' : '' }}>
                                                    D4/S1</option>
                                                <option value="S2"
                                                    {{ old('continuing_program', $user->continuing_program) === 'S2' ? 'selected' : '' }}>
                                                    S2</option>
                                                <option value="S3"
                                                    {{ old('continuing_program', $user->continuing_program) === 'S3' ? 'selected' : '' }}>
                                                    S3</option>
                                            </select>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="continuing_perguruan_tinggi"
                                                value="{{ old('continuing_perguruan_tinggi', $user->continuing_perguruan_tinggi) }}"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="continuing_jurusan"
                                                value="{{ old('continuing_jurusan', $user->continuing_jurusan) }}"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="telepon_kontak_darurat"
                                            value="{{ old('telepon_kontak_darurat', $user->telepon_kontak_darurat) }}"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="file" name="foto_profil" accept="image/*"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00a2e9]">
                                        @if ($user->foto_profil)
                                            <div class="mt-2"><img src="{{ Storage::url($user->foto_profil) }}"
                ...
                <form action="{{ route('profile.update-password') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="mb-4 relative">
                            <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Password Saat Ini <span
                                    class="text-[#ec1d1d]">*</span></label>
                            ...
                            <button type="button" onclick="togglePassword('current_password')"
                                class="absolute right-2 top-8 text-gray-500 hover:text-gray-700"><i
                        ...
                        <div class="mb-4 relative">
                            <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Password Baru <span
                                    class="text-[#ec1d1d]">*</span></label>
                        ...
                        <div class="mb-4 relative">
                            <label class="block text-sm font-medium text-[#1B1B1B] mb-1">Konfirmasi Password Baru <span
                                    class="text-[#ec1d1d]">*</span></label>
                    ...
                    <div class="mt-6">
                        <button type="submit"
                            class="bg-[#FCC626] text-[#1B1B1B] px-6 py-2 rounded-lg hover:bg-[#e6b222] transition-colors duration-200">Ubah
                            Password</button>
                    </div>
                </form>
            </div>
