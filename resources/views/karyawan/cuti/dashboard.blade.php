        ...
        <div class="p-4 sm:p-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                    ...
                    <p class="text-[#27438D] text-sm sm:text-base">Kelola pengajuan cuti Anda</p>
                </div>
                <a href="{{ route('karyawan.cuti.create') }}"
                   class="bg-[#27438D] text-white px-4 py-2 rounded-lg hover:bg-[#161758] transition-colors whitespace-nowrap text-sm sm:text-base">
                    + Ajukan Cuti
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6">
                <div class="bg-white rounded-lg shadow-md p-4 sm:p-6 text-center border-l-4 border-[#00a2e9]">
                    <p class="text-sm text-[#1B1B1B]">Jatah Cuti Tahunan</p>
                    <p class="text-2xl font-bold text-[#161758]">{{ $cutiTahunan->jatah_cuti ?? 12 }} hari</p>
                </div>
                <div class="bg-white rounded-lg shadow-md p-4 sm:p-6 text-center border-l-4 border-[#2E7D3E]">
                    <p class="text-sm text-[#1B1B1B]">Cuti Digunakan</p>
                    <p class="text-2xl font-bold text-[#161758]">{{ $cutiTahunan->cuti_digunakan ?? 0 }} hari</p>
                </div>
                <div class="bg-white rounded-lg shadow-md p-4 sm:p-6 text-center border-l-4 border-[#FCC626]">
                    <p class="text-sm text-[#1B1B1B]">Sisa Cuti</p>
                    <p class="text-2xl font-bold text-[#161758]">{{ $cutiTahunan->sisa_cuti ?? 0 }} hari</p>
                </div>
            </div>
