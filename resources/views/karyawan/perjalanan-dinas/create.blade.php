    ...
    <div class="flex-1 ml-0 md:ml-64 pt-14 sm:pt-16">
        <div class="p-4 sm:p-6 max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                <h1 class="text-xl font-bold text-[#161758] mb-2">Ajukan Perjalanan Dinas</h1>
                <p class="text-sm text-gray-500 mb-6">Isi form berikut untuk mengajukan perjalanan dinas</p>
